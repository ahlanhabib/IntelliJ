...
public class HalalRestaurant extends BangaliRestaurant implements Restaurant, FoodTruck {

	public void workers (){
		System.out.println("There will be 10 workers. ");
	}
	public void location() {
		System.out.println("The location of this Restaurant is in Los Angeles.");
	}
	public void size() {
